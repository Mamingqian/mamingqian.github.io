...
---
A survey paper of optical multilayer thin film structure inverse design. The survey covers all aspects from the traditional optimization-based methods to state-of-the-art deep learning-enabled inverse design algorithms.
